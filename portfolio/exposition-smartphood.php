...
<?php
  ...
  $date = "novembre 2014 à janvier 2015";
  include('./../projet-presentation.php');
?>
  <div class="bg-projet-image">
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3">
        <h2>Design du logotype</h2><br/>
        <img src="../img/portfolio/smartphood/logo.jpg" class="img-responsive center-block" alt="logotype final smart phood"/>
      </div>
    </div>
  </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <img src="../img/portfolio/smartphood/logo-2.jpg" class="img-responsive center-block" alt="logo piste 2"/>
    </div>
    <div class="row">
      <h3 class="text-center titre-logo col-sx-6">Piste 3 : typographie fait main, avec des grains de riz : une des bases de la cuisine viet.</h3>
  ...
  <section>
    <div class="bg-projet-image-sm">
    <div class="row">
      <div class="col-sm-8 col-sm-offset-2">
        <h2 class="respiration">Affiche et flyer</h2>
        <span class="visible-xs">
        <img src="../img/portfolio/smartphood/flyer.jpg" class="img-responsive center-block" alt="flyer smartphood">
        </span>
        <div id="galerie" class="text-center hidden-xs">
          <div id="galerie_big">
            <ul class="no-marge aligner">
              <li><img id="img1" src="../img/portfolio/smartphood/affiche.jpg" class="img-responsive" alt="webdesign du site galadrielle"/></li>
              <li><img id="img2" src="../img/portfolio/smartphood/flyer.jpg" class="img-responsive" alt="webdesign du site galadrielle"/></li>
            </ul>
          </div>
          <div id="galerie_nav">
            <ul class="no-marge center-ul">
              <li class="aligner opacity"><a rel="img1" href="#"><img src="../img/portfolio/smartphood/mini_1.jpg" alt="miniature webdesign du site galadrielle" class="img-responsive taille-max"/></a></li>
              <li class="aligner opacity"><a rel="img2" href="#"><img src="../img/portfolio/smartphood/mini_2.jpg" alt="miniature webdesign du site galadrielle" class="img-responsive taille-max"/></a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="bg-projet-carte-sm">
    <div class="row col-sm-8 col-sm-offset-2">
      <br/>
      <h2>Carte de visite</h2>
    </div>
    <div class="row">
      <img src="../img/portfolio/smartphood/carte-visite-smartphood.jpg" alt="carte de visite smartphood" title="carte de visite" class="img-responsive hidden-xs"/>
      <img src="../img/portfolio/smartphood/carte-visite-mobile.jpg" alt="carte de visite smartphood" title="carte de visite" class="img-responsive visible-xs"/>
    </div>
  </div>
